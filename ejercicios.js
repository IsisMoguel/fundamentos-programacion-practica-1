...
// Nombre del estudiante: Isis Alejandra Moguel Ramirez
...
function miInformacion() {
  ...
  const nombre = "Isis Alejandra Moguel Ramirez";
  const edad = 23;
  const carrera = "TSU en Desarrollo de Software y Negocios Digitales";
